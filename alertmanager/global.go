...
type GlobalConfig struct {
	...
	SMTPAuthUsername promconfig.Secret `yaml:"smtp_auth_username,omitempty"`
	SMTPAuthPassword promconfig.Secret `yaml:"smtp_auth_password,omitempty"`
